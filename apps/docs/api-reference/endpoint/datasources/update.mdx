...
api: 'POST https://dev.braviloai.com/api/datastores/update/{datastoreId}'
...
curl --location --request POST 'https://dev.braviloai.com/api/datastores/update/<datastoreId>' \
