...
api: 'POST https://dev.braviloai.com/api/datastores/upsert/{datastoreId}'
...
curl --location --request POST 'https://dev.braviloai.com/api/datastores/upsert/<datastoreId>' \
