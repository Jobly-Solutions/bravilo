      ...
      <Transition.Root>
        ...
        >
          ...
          >
            ...
            <MobileNavLink href="https://docs.braviloai.com/" target={'_blank'}>
              API Docs
            </MobileNavLink> */}
          ...
          <nav className="flex relative z-50 justify-between">
            <div className="flex items-center md:gap-x-12">
              ...
              <div className="hidden md:flex md:gap-x-6">
                ...
                {/* <NavLink href="https://docs.braviloai.com/" target={'_blank'}>
                Docs
              </NavLink> */}
                {/* <NavLink
                  href="https://databerry.getrewardful.com/"
            ...
            <div className="flex gap-x-5 items-center md:gap-x-8">
              ...
              {/* <Link href="https://app.braviloai.com/signin?product=chatbotgpt"> */}
