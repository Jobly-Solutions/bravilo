  ...
  const submitInvite = async (values: OrganizationInviteSchema) => {
    try {
      if (
        ...
        alert(
          'You have reached the maximum number of seats for your plan. Please contact support@braviloai.com to upgrade your plan.'
        );
        return;
      }
      ...
      if (
        ...
        toast.error(
          "Unable to send invite, please contact support@braviloai.com if it's persistent.",
          {
            duration: 5000,
          }
        );
