            ...
            <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://www.braviloai.com/blog"
                    target="_blank"
                  >
                    Blog
                  </a>
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://docs.braviloai.com/privacy/gdpr"
                    target="_blank"
                  >
                    GDPR
                  </a>
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://docs.braviloai.com/privacy/privacy-policy"
                    target="_blank"
                  >
                    Privacy
                  </a>
                ...
                <li>
                  <a
                    className="transition text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400"
                    href="https://docs.braviloai.com/privacy/terms"
                    target="_blank"
                  >
                    Terms
                  </a>
